...
const content = `import { TrendingUp, TrendingDown, Users, UserX, UserMinus, UserPlus, PhoneCall, Activity, Target } from 'lucide-react';
...
const filePath = path.join(__dirname, 'SummaryCards.tsx');
